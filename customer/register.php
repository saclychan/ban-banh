...
<div class="defaul-new-content">
	<div class="title-account"><span>Đăng ký tài khoản</span></div>
	<div class="content-defaul-new-product">
			...
			<table width="100%" border="0" cellpadding="3" cellspacing="0">
			  <tr>
				<td colspan="2" align="left" bgcolor="#F0F0F0"><span class="style3">Thông tin tài khoản </span></td>
			  </tr>
			  <tr>
				<td colspan="2">&nbsp;</td>
			  </tr>
			  <tr>
				<td width="35%" align="right" class="style2">Tên tài khoản:* </td>
				<td width="65%">
			  ...
			  <tr>
				<td colspan="1">&nbsp;</td>
				<td width="65%">&nbsp;<span id="checkUser" class="errorcustomer"></span></td>
			  </tr>
			  <tr>
				<td width="35%" align="right"><span class="style2">Mật khẩu:* </span></td>
				<td width="65%">
			  ...
			  <tr>
				<td colspan="1">&nbsp;</td>
				<td width="65%">&nbsp;<span id="checkCusPass" class="errorcustomer"></span></td>
			  </tr>
			  <tr>
				<td width="35%" align="right"><span class="style2">Xác nhận mật khẩu:* </span></td>
				<td width="65%">
			  ...
			  <tr>
				<td colspan="1">&nbsp;</td>
				<td width="65%"><span id="checkCusPass_conf" class="errorcustomer"></span></td>
			  </tr>
			  <tr>
				<td width="35%" align="right"><span class="style2">Email:*</span></td>
				<td width="65%">
			  ...
			  <tr>
				<td colspan="1">&nbsp;</td>
				<td width="65%"><span id="checkCusEmail" class="errorcustomer"></span></td>
			  </tr>
			  <tr>
				<td width="35%" align="right"><span class="style2">Câu hỏi bí mật:*</span></td>
				<td width="65%">
			  ...
			  <tr>
				<td colspan="1">&nbsp;</td>
				<td width="65%"><span id="checkCusQues" class="errorcustomer"></span></td>
			  </tr>
			  <tr>
				<td width="35%" align="right"><span class="style2">Trả lời:*</span></td>
				<td width="65%">
			  ...
			  <tr>
				<td colspan="1">&nbsp;</td>
				<td width="65%"><span id="checkCusAns" class="errorcustomer"></span></td>
			  </tr>
			  <tr>
			  `	<td colspan="2"></td>
			  </tr>
			  <tr>
				<td colspan="2" align="left" bgcolor="#F0F0F0"><span class="style3">Thông tin cá nhân</span></td>
			  </tr>
			  <tr>
				<td colspan="2">&nbsp;</td>
			  </tr>
			  <tr>
				<td width="35%" align="right" class="style2">Họ tên:* </td>
				<td width="65%"><input class="inputtext" name="CusName" type="text" id="CusName" size="30" onFocus="style.backgroundColor='#F0F0F0'" onBlur="style.backgroundColor='white'" /></td>
				</tr>
			  <tr>
				<td colspan="1">&nbsp;</td>
				<td width="65%"><span id="checkCusName" class="errorcustomer"></span></td>
			  </tr>
			  <tr>
				<td width="35%" align="right"><span class="style2">Địa chỉ:* </span></td>
				<td width="65%"><input class="inputtext" name="CusAdd" type="text" id="CusAdd" size="30" onFocus="style.backgroundColor='#F0F0F0'" onBlur="style.backgroundColor='white'" /></td>
				</tr>
			  <tr>
				<td colspan="1">&nbsp;</td>
				<td width="65%"><span id="checkCusAdd" class="errorcustomer"></span></td>
			  </tr>
			  <tr>
				<td width="35%" align="right"><span class="style2">Số điện thoại: </span></td>
				<td width="65%"><input class="inputtext" name="CusPhone" type="text" id="CusPhone" size="30" onFocus="style.backgroundColor='#F0F0F0'" onBlur="style.backgroundColor='white'" /></td>
				</tr>
			  <tr>
				<td colspan="1">&nbsp;</td>
				<td width="65%"><span id="checkCusPhone" class="errorcustomer"></span></td>
			  </tr>
			  <tr>
				<td width="35%" align="right"><span class="style2">Giới tính:</span></td>
				<td width="65%">
					<span class="style2">
