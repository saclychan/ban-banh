<?
	...
	{
		case "admin_manager":
			require("admin/admin_manager.php");
			break;	
		case "admin_managerAdd":
			require("admin/admin_managerAdd.php");
			break;
		case "admin_managerEdit":
			require("admin/admin_managerEdit.php");
			break;				
		case "admin_editinfo":
		...
		case "chat_manager":
			require("admin/chat_manager.php");
			break;	
		case "chat_manager_add":
			require("admin/chat_manager_add.php");
			break;	
		case "chat_manager_edit":
			require("admin/chat_manager_edit.php");
			break;								
