...
<?
	...
	$record_per_page = 9;
	$pagenum = $_GET["page"];
	$page = "index.php?go=search&page=1";
	$sqlpro = "SELECT * FROM product,category where product.ProStatus=1 and product.CateID=category.CateID And product.ProName Like '%".$keyword."%'";	
